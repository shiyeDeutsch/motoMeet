...
namespace motoMeet
{
    public class Event : EntityBase
    {
        ...
        public virtual ICollection<EventItem> RequiredItems { get; set; } = new List<EventItem>();
        ...
        public virtual ICollection<EventStage> Stages { get; set; } = new List<EventStage>();
